export const VISUAL_DIAGNOSTIC_STAGES = Object.freeze([
  ...
  'CHANNEL_CREATE', 'CARD_CREATE', 'BEHAVIOR_LAYOUT', 'FLIGHT_LAYOUT', 'SKIN_RENDER', 'EFFECT_RUN', 'LIFECYCLE_EXIT'
]);
...
export const VISUAL_DIAGNOSTIC_CODES = Object.freeze([
  ...
  'VISUAL_BEHAVIOR_UNAVAILABLE', 'VISUAL_BEHAVIOR_LAYOUT_FAILED',
  'FLIGHT_UNAVAILABLE', 'FLIGHT_LAYOUT_FAILED', 'VISUAL_SKIN_INVALID',
...
const SOURCE_FIELDS = Object.freeze(['packageId', 'profileId', 'channelId', 'eventId', 'behaviorId', 'flight', 'cardTypeId', 'skinId', 'effectId', 'assetId']);
