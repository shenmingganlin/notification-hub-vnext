...
> 更新时间：2026-09-16
>
> 这份索引是工作台计划的入口。历史计划保留用于追溯。视觉本体以 09-13 为准；**当前工程入口**是词表与通道规约改革。

## 当前工程入口

`2026-09-16-lexicon-and-channel-charter.md`

后端清洗：飞法 / 飞法通道 / 规约 / 动态 / 寿命 / 卡面 / 事件巷。通道规约独立户口，配置包不带规约。不实现 PID、路径、淡入。完成后版本 0.1.8。Git 先把 0.1.7 工作区收成回滚点。
